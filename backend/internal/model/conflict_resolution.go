...
type ConflictResolution struct {
	...
	FreezeStatus        string `gorm:"size:24;index;not null;default:'frozen'"`
	FrozenChangesJSON   string `gorm:"type:text;not null;default:'[]'"`
	FreezeBlockedReason string `gorm:"size:64;not null;default:''"`
